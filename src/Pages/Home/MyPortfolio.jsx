    ...
    <section className="portfolio--section" id="MyPortfolio">
      <div className="portfolio--container-box">
        ...
        <div>
            ...
            <a href="https://github.com/AbyG1?tab=repositories" className="btn btn-github">
        ...
        {data?.portfolio?.map((item, index) => (
          <div key={index} className="portfolio--section--card">
            ...
            <div className="portfolio--section--card--content">
              ...
              <a href={item.rlink} className="portfolio--link" target="_blank">
                <p className="text-sm ">
                  Github Link:
                  <svg
              ...
              <a href={item.llink} className="portfolio--link" target="_blank">
